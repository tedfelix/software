1 'DOCTOR, Version 2.1
2 CLEAR 1000
3 KEY OFF
4 ' Copyright 2017, Ted Felix
5 ' File date: 9/25/1991 10:31:12 PM
10 'SUPERVISOR
...
305 NEXT PS: NEXT I
310 DATA " MOM "," MOTHER "," DAD "," FATHER "
...
800 IF YO$ = "" THEN 310 ELSE RAN = RND(5): ON RAN GOTO 810,810,810,860,860
...
880 PRINT "DOES THAT HAVE ANYTHING TO DO WITH THE FACT THAT YOU" + YO$ + "?": X = 1: GOTO 900
890 PRINT "EARLIER YOU SAID YOUR" + YO$ + ".": X = 1: GOTO 900
900 RETURN
910 'Marker remover
920 IF X = 1 THEN 960
...
1100 PRINT "REALLY, " + KE$ + "?": GOTO 1470
...
1220 PRINT "WHETHER OR NOTE YOU CAN" + DR$ + " DEPENDS ON YOU MORE THAN ON ME.": GOTO 1470
...
1370 PRINT "DO YOU BELIEVE THAT I DON'T" + DR$ + "?": GOTO 1470
1380 PRINT "DO YOU THINK YOU SHOULD BE ABLE TO" + DR$ + "?": GOTO 1470
1390 PRINT "WHAT WOULD IT MEAN TO YOU IF YOU GOT" + DR$ + "?": GOTO 1470
1400 GOSUB 1510: GOSUB 1540: PRINT "I AM SORRY TO HEAR YOU ARE" + DR$ + 0!": GOTO 1470
