...
161 PRINT#1,"Hi!  I'm Eliza.  What's your problem?"
199 '------------USER INPUT SECTION----------------
200 LINE INPUT">";I$
201 PRINT#1,">";I$
205 I$=" "+I$+"  "
...
250 NEXT
260 IF I$=P$THEN PRINT"Please don't repeat yourself!":PRINT#1,"Please don't repeat yourself!":GOTO 170
265 IF I$=" BYE  "THEN PRINT"Goodbye, I hope I have been helpful.":END
...
620 IF RIGHT$(F$,1)<>"*"THEN PRINT F$:PRINT#1,F$:P$=I$:GOTO 200
630 PRINT LEFT$(F$,LEN(F$)-1);C$
635 PRINT#1,LEFT$(F$,LEN(F$)-1);C$
640 P$=I$:GOTO 200
...
4999 '-----------New Code to support Logging----------------------
5000 PRINT"Eliza will see you now, please enter the name of your file..."
5010 FILES"*.ELZ"
5020 PRINT:PRINT"If you are a new patient, please enter a file name of 8 letters or less"
5030 INPUT"Filename [.ELZ]";FLN$
5035 IF INSTR(FLN$,".")=0 THEN FLN$=FLN$+".ELZ"
5040 OPEN FLN$ FOR APPEND AS #1
5060 PRINT"When you are finished with the doctor, please type BYE."
5070 PRINT#1,
5071 PRINT#1,"**************************************************************"
5072 PRINT#1,
5080 PRINT#1,"Session Date: ";DATE$;"  Time: ";TIME$
5090 RETURN
